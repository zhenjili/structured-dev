...
A skill for systematic, feature-driven development of complex projects.

## What it does

When you invoke `/structured-dev`, the agent adopts a disciplined development workflow:

1. **Initialization**: Analyzes the project, generates a `feature_list.json` with granular testable features, and creates `progress.txt` for session logging
...
- **progress.txt**: Session log documenting what was accomplished, what's next, and any blockers
